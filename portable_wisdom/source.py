...
class Source:
    def to_epub(self, style=None):
        ...
        for i, article in enumerate(articles):
            ...
            chapter.content = '<html><head><link rel="stylesheet" href="style/default.css" /></head><body>' + \
        ...
        with open(style_path) as f:
            nav_css = epub.EpubItem(
                uid="style_nav", file_name="style/default.css", media_type="text/css", content=f.read())
